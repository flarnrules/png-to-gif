...
# Sorts the files based on their number, in ascending order 
# Make sure all pngs are named as integers like 1, 2 or 001, 002
file_list = sorted(glob.glob(f"{image_folder}/*.png"))
